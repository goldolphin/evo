...
static string_t s_bool_type_name = {(uint8_t *) "Bool", 3};
static type_t s_bool_type = {TC_FUN, &s_bool_type_name};
type_t * BOOL_TYPE = &s_bool_type;

static string_t s_int_type_name = {(uint8_t *) "Int", 3};
static type_t s_int_type = {TC_FUN, &s_int_type_name};
type_t * INT_TYPE = &s_int_type;

static string_t s_long_type_name = {(uint8_t *) "Long", 3};
static type_t s_long_type = {TC_FUN, &s_long_type_name};
type_t * LONG_TYPE = &s_long_type;

static string_t s_double_type_name = {(uint8_t *) "Double", 3};
static type_t s_double_type = {TC_FUN, &s_double_type_name};
...
static string_t s_string_type_name = {(uint8_t *) "String", 3};
static type_t s_string_type = {TC_FUN, &s_string_type_name};
