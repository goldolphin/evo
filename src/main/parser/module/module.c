...
static inline bool define_op(module_t * module, operator_table_t * table, const char * op, int precedence, const char * var) {
    string_t var_name;
